...
function Server(compiler, options) {
  ...
  const app = this.app = new express(); // eslint-disable-line
	app.get('/restapi/shopping/restaurant', (request, response)=>{
    // let data = require('./');
    // let data = require('../../../mock-data//sellerdetail.json');
    
    let result = fs.readFileSync('./mock-data/sellerdetail.json');
